...
PM_START_TEXT = """
Hello, I'M Techboy237bot
`ɪ'ᴍ ʜᴇʀᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘꜱ! ʜɪᴛ` /help
Maintained by @techboy237bot ❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/techboy237bot?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/techboy237botlogs"),
        InlineKeyboardButton(
...
Powered by :- [Awesome Bots](t.me/techboy237)"""

techboy237bot_IMG = "https://telegra.ph/Techboy237-04-07"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [Hero](t.me/techboy237) \
 Supporting isnt always financial! [Techboy237botSupport](t.me/techboy237) \
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Layla*, a powerful group management bot built to help you manage your group easily.
                 ...
                 \n❍ Awesome Bots @techboy237
                 \n❍ Support Group @techboy237
                 \n❍ Assistant @LaylaAssistant.
                 \nHere is the [💾Repository](https://github.com/techboy237/Techboy237bot).
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *techboy237*
                 \nHere is the [Source Code](https://github.com/techboy237/Techboy237bot .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
